...
class TestTypeChecking {
    ...
    void testDichiarazioniRipetute() throws Exception {
        // Il file contiene: int a; float a; 
    ...
    void testIdNonDichiarato() throws Exception {
        // Il file contiene l'uso della variabile 'b' non dichiarata 
    ...
    void testTipoNonCompatibile() throws Exception {
        // Il file tenta di assegnare un float a un int 
    ...
    void testFileCorretti() throws Exception {
        // Test per i file 5, 6 e 7 che sono semanticamente corretti
